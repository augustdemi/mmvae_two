...
def create_parser():
    ...
    parser.add_argument( '--z_dim', default=10, type=int, 
      help='dimension of the private-I latent representation' )
...
#        help='# times to repeat reconstruction (0 for no evaluation)' )
    ...
    #
#    parser.add_argument( '--williams', action='store_true', default=False, 
#        help="whether or not to evaluate williams metrics" )
