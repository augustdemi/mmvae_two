...
class Solver(object):
    ...
    def train(self):
        ...
        for iteration in range(start_iter, self.max_iter + 1):
            ...
            # loss_recon_infA = reconstruction_loss(XA, XA_infA_recon, distribution="bernoulli")
            #
            print(XB_infB_recon)
            loss_recon_infB = reconstruction_loss(XB, torch.sigmoid(XB_infB_recon), distribution="bernoulli", index = index)
            # loss_recon_infB = reconstruction_loss(XB, XB_infB_recon, distribution="bernoulli")
            
            # loss_recon_POE = \
            #     reconstruction_loss(XA, XA_POE_recon, distribution="bernoulli") + \
            #     reconstruction_loss(XB, XB_POE_recon, distribution="bernoulli")
