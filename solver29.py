...
class Solver(object):
    ...
    def train(self):
        ...
        for iteration in range(start_iter, self.max_iter + 1):
            ...
            cate_prob_POE = torch.exp(torch.log(torch.tensor(1 / 10)) + torch.log(cate_prob_infA) + torch.log(cate_prob_infB))
            ...
            if iteration % self.print_iter == 0:
                prn_str = ( \
                          ...
                          (iteration, epoch,
                           ...
                           -(loss_recon_infA_givenB.item() + loss_kl_infA_givenB.item()),
