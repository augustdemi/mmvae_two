...
class Solver(object):
    ...
    def __init__(self, args):
        ...
        self.name = '%s_unsup_%s_paired_cnt_%s_lamkl_%s_zA_%s_zB_%s_zS_%s_HYPER_beta1_%s_beta2_%s_beta3_%s_beta11_%s_beta22_%s_beta33_%s_lA_%s_lB_%s' % \
                    (
                        args.dataset, args.unsup, args.paired_cnt, args.lamkl, args.zA_dim, args.zB_dim, args.zS_dim, args.beta1, args.beta2,
